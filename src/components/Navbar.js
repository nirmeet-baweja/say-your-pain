...
const Navbar = ({ logo, currentLanguage }) => {
  ...
  return (
    <div className="fixed z-[10] flex h-20 w-full flex-row items-center justify-between bg-gradient-to-b from-blue-400/20 from-10% to-white to-90% p-5 font-bold">
